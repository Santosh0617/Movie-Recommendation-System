...
<img src="Demo/images.jpg" alt="workflow" width="70%">
...
```bash
https://github.com/Maddy2580/Movie_recommender_System_Using_Machine_Learning
```
...
```bash
Author: Chinam Madhusudan Patro
Email: ch.madhusudanpatro@gmail.com
